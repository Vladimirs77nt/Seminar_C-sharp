...
Console.WriteLine("Сначала введите кол-во вводимых строк, затем начните вводить строки завершая их нажатием клавиши Enter");
...
else Console.Write("В введенных данных нет строк удовлетворяющих условиям задачи");